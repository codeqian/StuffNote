...
public class sqlHelper extends SQLiteOpenHelper {
    ...
    {
        super(context, BaseConfig._DbName, null, 3);//最后个参数用以更新数据库
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + BaseConfig._ItemListTableName +" (_id INTEGER PRIMARY KEY AUTOINCREMENT, _name VARCHAR, _loc VARCHAR, _fun VARCHAR, _color VARCHAR, _des VARCHAR, _image VARCHAR, _time VARCHAR,_fq INTEGER)");
        //标签表(id，标签类型，标签名
